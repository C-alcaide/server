...
struct mixer::impl
{
    ...
    {
        image_mixer_->set_target_color(default_color_space_, default_color_transfer_, auto_color_convert, auto_tone_map, display_peak_luminance, sdr_reference_white, auto_gamut_compress, straight_alpha_grading);
    }
...
mixer::mixer(int channel_index, spl::shared_ptr<diagnostics::graph> graph, spl::shared_ptr<image_mixer> image_mixer, core::color_space default_color_space, core::color_transfer default_color_transfer, bool auto_color_convert, int auto_tone_map, float display_peak_luminance, float sdr_reference_white, bool auto_gamut_compress, bool straight_alpha_grading)
    : impl_(new impl(channel_index, std::move(graph), std::move(image_mixer), default_color_space, default_color_transfer, auto_color_convert, auto_tone_map, display_peak_luminance, sdr_reference_white, auto_gamut_compress, straight_alpha_grading))
{
}
