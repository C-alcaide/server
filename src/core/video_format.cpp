  ...
  public:
        ...
        : formats_()
    {
        const std::vector<video_format_desc> default_formats = {
            ...
            {video_format::x1080p10000, 1, 1920, 1080, 1920, 1080, 100000, 1000, L"1080p10000", {480}},
            {video_format::x1080p12000, 1, 1920, 1080, 1920, 1080, 120000, 1000, L"1080p12000", {400}},
            {video_format::x2160p10000, 1, 3840, 2160, 3840, 2160, 100000, 1000, L"2160p10000", {480}},
            {video_format::x2160p12000, 1, 3840, 2160, 3840, 2160, 120000, 1000, L"2160p12000", {400}},
        };
