...
public:
                    ...
                    int /*port_index*/) override
    {
        ...
        //   - the encode loop is what closes the muxer, so replacing mov_muxer_/
        //     mxf_muxer_ without draining it left the file being written unfinalized.
        //   - the CUDA buffers are reallocated below, under the running thread.
        //
