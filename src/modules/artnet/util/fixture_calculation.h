...
// in sacn/util/fixture_calculation.h. They now live in modules/dmx_common; this
// header just re-exports them under caspar::artnet so the consumer reads the same.
